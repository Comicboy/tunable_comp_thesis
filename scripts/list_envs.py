...
All the environments are registered in the `tunable_comp_thesis` extension. They start
...
import tunable_comp_thesis.tasks  # noqa: F401


def main():
    """Print all environments registered in `tunable_comp_thesis` extension."""
