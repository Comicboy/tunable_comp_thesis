...
from .tunable_comp_thesis_marl_env_cfg import TunableCompThesisMarlEnvCfg


class TunableCompThesisMarlEnv(DirectMARLEnv):
    cfg: TunableCompThesisMarlEnvCfg

    def __init__(self, cfg: TunableCompThesisMarlEnvCfg, render_mode: str | None = None, **kwargs):
